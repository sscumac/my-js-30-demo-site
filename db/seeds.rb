...
challenge_15 = Challenge.create(name: "Adding Up Times with Reduce", number: 15)
challenge_16 = Challenge.create(name: "Frantic Photo Booth", number: 16)
challenge_27 = Challenge.create(name: "Speech Regognition", number: 17)
challenge_18 = Challenge.create(name: "Highlight Links by Hover", number: 18)
challenge_19 = Challenge.create(name: "Text to Speech", number: 19)
challenge_20 = Challenge.create(name: "Slide into Sticky Nav", number: 20)
